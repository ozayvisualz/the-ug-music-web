...
type Song = { id: string; title: string; artist: any; duration: number; url: string; coverUrl?: string; fileUrl?: string; hlsUrl?: string; artistId?: string; featuredArtistId?: string };
...
export default function DiscoverScreen() {
  ...
  const handlePlaySong = useCallback(
    (song: Song) => {
      setQueue([{ id: song.id, title: song.title, artist: getArtistName(song.artist), url: song.fileUrl || song.hlsUrl || "", duration: song.duration || 180, coverUrl: song.coverUrl, artistId: song.artistId, featuredArtistId: song.featuredArtistId }]);
    },
    [setQueue],
  );
